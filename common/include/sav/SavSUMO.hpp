...
extern "C" {
#include "../../memecrypto/memecrypto.h"
#include "sha256.h"
}
...
{
protected:
    static constexpr u32 chkofs[37] = { 
    ...
    static constexpr u32 chklen[37] = {
    ...
    static constexpr u16 formtable[230] =  {
...
public:
    ...
    int maxAbility(void) const { return 232; }
