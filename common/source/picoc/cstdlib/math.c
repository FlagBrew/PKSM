...
void MathSetupFunc(Picoc* pc)
{
    ...
    VariableDefinePlatformVar(
        pc, NULL, "M_LOG2E", &pc->FloatType, (union AnyValue*)&M_LOG2EValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_LOG10E", &pc->FloatType, (union AnyValue*)&M_LOG10EValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_LN2", &pc->FloatType, (union AnyValue*)&M_LN2Value, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_LN10", &pc->FloatType, (union AnyValue*)&M_LN10Value, false);
    VariableDefinePlatformVar(pc, NULL, "M_PI", &pc->FloatType, (union AnyValue*)&M_PIValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_PI_2", &pc->FloatType, (union AnyValue*)&M_PI_2Value, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_PI_4", &pc->FloatType, (union AnyValue*)&M_PI_4Value, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_1_PI", &pc->FloatType, (union AnyValue*)&M_1_PIValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_2_PI", &pc->FloatType, (union AnyValue*)&M_2_PIValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_2_SQRTPI", &pc->FloatType, (union AnyValue*)&M_2_SQRTPIValue, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_SQRT2", &pc->FloatType, (union AnyValue*)&M_SQRT2Value, false);
    VariableDefinePlatformVar(
        pc, NULL, "M_SQRT1_2", &pc->FloatType, (union AnyValue*)&M_SQRT1_2Value, false);
}
