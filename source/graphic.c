...
u32 logoColors[15] = {RGBA8(0, 136, 222, 220), 
					RGBA8(203, 39, 69, 220),
					RGBA8(247, 139, 50, 220),
					RGBA8(115, 118, 252, 220),
					RGBA8(241, 148, 45, 220),
					RGBA8(75, 139, 190, 220),
					RGBA8(138, 207, 231, 220),
					RGBA8(195, 135, 182, 220),
					RGBA8(196, 170, 76, 220),
					RGBA8(248, 169, 64, 220),
					RGBA8(108, 131, 185, 220),
					RGBA8(227, 236, 243, 220),
					RGBA8(62, 74, 72, 220),
					RGBA8(0, 167, 215, 220),
					RGBA8(223, 105, 95, 220),
};

int logo_lookup6[7] = {0, 64, 121, 183, 250, 320, 375};
int logo_lookup4[6] = {0, 54, 116, 177, 233, 291};
int logo_lookup5[5] = {0, 53, 104, 176, 253};
