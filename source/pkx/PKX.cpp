...
bool PKX::gen7(void) const { return version() >= 30 && version() <= 33;}

bool PKX::gen6(void) const { return version() >= 24 && version() <= 29; }

bool PKX::gen5(void) const { return version() >= 20 && version() <= 23; }

bool PKX::gen4(void) const { return version() >= 7 && version() <= 12 && version() != 9; }
