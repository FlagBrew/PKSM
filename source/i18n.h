...
typedef enum {
	...
	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_FRIENDSHIP,  // Line 317
	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_AFFECTION,   // Line 317
	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_INTENSITY,   // Line 317
	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_MEMORY,      // Line 317
	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_FEELING,     // Line 317

	S_GRAPHIC_HEXEDITOR_EGG_YEAR,                     // Line 317
	S_GRAPHIC_HEXEDITOR_EGG_MONTH,                    // Line 317
	S_GRAPHIC_HEXEDITOR_EGG_DAY,                      // Line 317

	S_GRAPHIC_HEXEDITOR_MET_YEAR,                     // Line 317
	S_GRAPHIC_HEXEDITOR_MET_MONTH,                    // Line 317
	S_GRAPHIC_HEXEDITOR_MET_DAY,                      // Line 317
	S_GRAPHIC_HEXEDITOR_MET_LEVEL,                    // Line 317

	S_GRAPHIC_HEXEDITOR_ORIGINAL_TRAINER_GENDER,      // Line 317

	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_HP,             // Line 317
	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_ATK,            // Line 317
	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_DEF,            // Line 317
	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_SPATK,          // Line 317
	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_SPDEF,          // Line 317
	S_GRAPHIC_HEXEDITOR_HYPER_TRAINED_SPEED,          // Line 317
} AppTextCode;
