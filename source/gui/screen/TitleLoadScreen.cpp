...
void TitleLoadScreen::draw() const
{
    ...
    if (selectedTitle != -2)
    {
        ...
        Gui::staticText(selectedTitle == -1 ? i18n::localize("LOADER_CARTRIDGE") : i18n::localize("LOADER_SD"),
                            nextMediaPart, 58, FONT_SIZE_11, FONT_SIZE_11, COLOR_WHITE, TextPosX::LEFT, TextPosY::TOP);
    }
    else
    {
