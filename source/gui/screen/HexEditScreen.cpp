        ...
        if (pkm->gen6() || pkm->gen7())
        {
            switch (i)
            {
                ...
                case 0x2A:
                    ...
                    for (int j = 0; j < 6; j++)
                    {
                        buttons[i].push_back(new HexEditButton(70, 90 + j * 16, 13, 13, [this, i, j](){ return this->toggleBit(i, j); }, ui_sheet_emulated_toggle_green_idx, i18n::localize(std::string(marks[j])), true, j));
                ...
                case 0x3A:
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        buttons[i].push_back(new HexEditButton(70, 90 + j * 16, 13, 13, [this, i, j](){ return this->toggleBit(i, j); }, ui_sheet_emulated_toggle_green_idx, i18n::localize(std::string(gen67ToggleTexts[currRibbon])), true, j));
                        buttons[i].back()->setToggled((pkm->rawData()[i] >> j) & 0x1);
                        currRibbon++;
                    }
                    break;
        ...
        else if (pkm->gen5())
        {
            switch (i)
            {
                ...
                case 0x63:
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        buttons[i].push_back(new HexEditButton(70, 90 + j * 16, 13, 13, [this, i, j](){ return this->toggleBit(i, j); }, ui_sheet_emulated_toggle_green_idx, i18n::localize(std::string(gen5ToggleTexts[currRibbon])), true, j));
                        buttons[i].back()->setToggled((pkm->rawData()[i] >> j) & 0x1);
                        currRibbon++;
                    }
                    break;
        ...
        else if (pkm->gen4())
        {
            switch (i)
            {
                ...
                case 0x63:
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        buttons[i].push_back(new HexEditButton(70, 90 + j * 16, 13, 13, [this, i, j](){ return this->toggleBit(i, j); }, ui_sheet_emulated_toggle_green_idx, i18n::localize(std::string(gen4ToggleTexts[currRibbon])), true, j));
                        buttons[i].back()->setToggled((pkm->rawData()[i] >> j) & 0x1);
                        currRibbon++;
                    }
                    break;
