...
namespace pksm::ui::render {
    ...
    void PatternBackground::SetBackgroundColor(const pu::ui::Color& color) {
        if (this->backgroundColor.r != color.r ||
    ...
    void PatternBackground::SetLineColor(const pu::ui::Color& color) {
        if (this->lineColor.r != color.r ||
            this->lineColor.g != color.g ||
            this->lineColor.b != color.b ||
    ...
    void PatternBackground::CreateBackgroundTexture() {
        ...
        backgroundTexture = PatternRenderer::CreateDiagonalLinePattern(
            width, height,
            cornerRadius,
            lineSpacing,
            lineThickness,
