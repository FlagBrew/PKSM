...
MockTitleDataProvider::MockTitleDataProvider() {
    ...
    mockInstalledTitles = {
        ...
        std::make_shared<titles::Title>("Pokémon: Let's Go Eevee", "romfs:/gfx/mock/lg_eevee_menu_icon.jpg", 0x00175201),
        std::make_shared<titles::Title>("Pokémon Sword", "romfs:/gfx/mock/sword_menu_icon.jpg", 0x00175202),
        std::make_shared<titles::Title>("Pokémon Shield", "romfs:/gfx/mock/shield_menu_icon.jpg", 0x00175203),
        std::make_shared<titles::Title>("Pokémon Shining Pearl", "romfs:/gfx/mock/shining_pearl_menu_icon.jpg", 0x00175204)
    };
}
