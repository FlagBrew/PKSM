...
std::string PK5::nickname(void) const { return StringUtils::getString(data, 0x48, 11, u'\uFFFF'); }
void PK5::nickname(const std::string& v) { StringUtils::setString(data, v, 0x48, 11, u'\uFFFF', 0); }

u8 PK5::version(void) const { return data[0x5F]; }
void PK5::version(u8 v) { data[0x5F] = v; }

std::string PK5::otName(void) const { return StringUtils::getString(data, 0x68, 8, u'\uFFFF'); }
void PK5::otName(const std::string& v) { StringUtils::setString(data, v, 0x68, 8, u'\uFFFF', 0); }
