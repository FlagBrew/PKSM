...
u16 WB7::ID() const { return *(u16*)(data); }
...
u16 WB7::object(int index) const { return *(u16*)(data + 0x68 + index * 4); }
...
u16 WB7::objectQuantity(int index) const { return *(u16*)(data + 0x6A + index * 4); }

bool WB7::pokemon(void) const { return type() == 0; }

u8 WB7::PIDType(void) const { return *(u8*)(data + 0xA3); }

bool WB7::shiny(void) const { return PIDType() == 2; }

u16 WB7::TID(void) const { return *(u16*)(data + 0x68); }

u16 WB7::SID(void) const { return *(u16*)(data + 0x6A); }

u8 WB7::version(void) const { return *(u8*)(data + 0x6C); }

u32 WB7::encryptionConstant(void) const { return *(u32*)(data + 0x70); }

u8 WB7::ball(void) const { return *(u8*)(data + 0x76); }

u16 WB7::heldItem(void) const { return *(u16*)(data + 0x78); }

u16 WB7::move(u8 m) const { return *(u16*)(data + 0x7A + m*2); }

u16 WB7::species(void) const { return *(u16*)(data + 0x82); }

u8 WB7::alternativeForm(void) const { return *(u8*)(data + 0x84); }

u8 WB7::nature(void) const { return *(u8*)(data + 0xA0); }

u8 WB7::gender(void) const { return *(u8*)(data + 0xA1); }
...
u8 WB7::abilityType(void) const { return *(u8*)(data + 0xA2); }

u8 WB7::metLevel(void) const {  return *(u8*)(data + 0xA8); }

u8 WB7::level(void) const { return *(u8*)(data + 0xD0); }

bool WB7::egg(void) const { return *(u8*)(data + 0xD1) == 1; }

u16 WB7::eggLocation(void) const { return *(u16*)(data + 0xA4); }

u16 WB7::metLocation(void) const { return *(u16*)(data + 0xA6); }

u8 WB7::awakened(u8 index) const { return *(u8*)(data + 0xA9 + index); }

u8 WB7::iv(u8 index) const { return *(u8*)(data + 0xAF + index); }

u8 WB7::otGender(void) const { return *(u8*)(data + 0xB5); }

u16 WB7::additionalItem(void) const { return *(u16*)(data + 0xD2); }

u32 WB7::PID(void) const { return *(u32*)(data + 0xD4); }

u16 WB7::relearnMove(u8 index) const { return *(u16*)(data + 0xD8 + index * 2); }

u8 WB7::otIntensity(void) const { return *(u8*)(data + 0xE0); }

u8 WB7::otMemory(void) const { return *(u8*)(data + 0xE1); }

u16 WB7::otTextvar(void) const { return *(u8*)(data + 0xE2); }

u8 WB7::otFeeling(void) const { return *(u8*)(data + 0xE4); }

u8 WB7::ev(u8 index) const { return *(u8*)(data + 0xE5 + index); }

bool WB7::ribbon(u8 category, u8 index) const { return (*(data + 0x74 + category) & (1 << index)); }
