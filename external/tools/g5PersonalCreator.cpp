...
int main()
{
    ...
    FILE* personalFile = fopen("personal_b2w2", "rb");
    ...
    printf("constexpr int personal5_size = %li;\n", entries * sizeof(PKSMPersonalEntry));

    printf("constexpr int personal5_entrysize = %li;\n", sizeof(PKSMPersonalEntry));

    FILE* outPersonal = fopen("personal5", "wb");
    for (size_t i = 0; i < entries; i++)
    {
