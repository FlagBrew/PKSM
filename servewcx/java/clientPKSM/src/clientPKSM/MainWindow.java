...
public class MainWindow {
	...
	private void initialize() {
		...
		frmPksmClient.setTitle("servewcx");
		...
		JButton btnSelectFiles = new JButton("Select .wc6/.wc7 files");
		...
		JButton btnSendFiles = new JButton("Send .wc6/.wc7 files");
		btnSendFiles.setBounds(150, 240, 191, 52);
		frmPksmClient.getContentPane().add(btnSendFiles);
		
		JLabel lblPksmClientV = new JLabel("servewcx v1.0. To use with PKSM, by Bernardo Giordano.");
