...
public:
    ...
    void addLine(bool top, int x1, int y1, int x2, int y2, int width, u32 color);
...
private:
    ...
    struct Box
    {
        Box(bool top, int x, int y, int w, int h, u32 color) : top(top), x(x), y(y), w(w), h(h), color(color) {}
        bool top;
        int x;
        int y;
        int w;
    ...
    struct Line
    {
        Line(bool top, int x1, int y1, int x2, int y2, int w, u32 color) : top(top), x1(x1), y1(y1), x2(x2), y2(y2), w(w), color(color) {}
        bool top;
        int x1;
        int y1;
        int x2;
    ...
    struct Circle
    {
        Circle(bool top, int x, int y, int radius, u32 color) : top(top), x(x), y(y), radius(radius), color(color) {}
        bool top;
        int x;
        int y;
        int radius;
