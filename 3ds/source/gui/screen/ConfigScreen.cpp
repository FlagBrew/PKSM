...
void ConfigScreen::drawBottom() const
{
    ...
    {
        Gui::text(fmt::format(i18n::localize("GENERATION"), (std::string)pksm::Generation::ONE),
            19, 30, FONT_SIZE_12, COLOR_WHITE, TextPosX::LEFT, TextPosY::TOP);
        Gui::text(fmt::format(i18n::localize("GENERATION"), (std::string)pksm::Generation::TWO),
        ...
        Gui::text(fmt::format(i18n::localize("GENERATION"), (std::string)pksm::Generation::SIX),
