...
namespace
{
    constexpr std::string_view hyperVals[]        = {"HYPER_HP", "HYPER_ATTACK", "HYPER_DEFENSE", "HYPER_SPATK", "HYPER_SPDEF", "HYPER_SPEED"};
    constexpr std::string_view marks[]            = {"CIRCLE", "TRIANGLE", "SQUARE", "HEART", "STAR", "DIAMOND"};
    constexpr std::string_view gen3ToggleTexts[]  = {"BAD_EGG", "HAS_SPECIES", "EGG", "HOENN_CHAMPION_RIBBON", "WINNING_RIBBON", "VICTORY_RIBBON",
        "ARTIST_RIBBON", "EFFORT_RIBBON", "BATTLE_CHAMPION_RIBBON", "REGIONAL_CHAMPION_RIBBON", "NATIONAL_CHAMPION_RIBBON", "COUNTRY_RIBBON",
        "NATIONAL_RIBBON", "EARTH_RIBBON", "WORLD_RIBBON", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "FATEFUL_ENCOUNTER"};
    constexpr std::string_view gen4ToggleTexts[]  = {"SINNOH_CHAMP_RIBBON", "ABILITY_RIBBON", "GREAT_ABILITY_RIBBON", "DOUBLE_ABILITY_RIBBON",
        "MULTI_ABILITY_RIBBON", "PAIR_ABILITY_RIBBON", "WORLD_ABILITY_RIBBON", "ALERT_RIBBON", "SHOCK_RIBBON", "DOWNCAST_RIBBON", "CARELESS_RIBBON",
        "RELAX_RIBBON", "SNOOZE_RIBBON", "SMILE_RIBBON", "GORGEOUS_RIBBON", "ROYAL_RIBBON", "GORGEOUS_ROYAL_RIBBON", "FOOTPRINT_RIBBON",
        "RECORD_RIBBON", "HISTORY_RIBBON", "LEGEND_RIBBON", "RED_RIBBON", "GREEN_RIBBON", "BLUE_RIBBON", "FESTIVAL_RIBBON", "CARNIVAL_RIBBON",
        "CLASSIC_RIBBON", "PREMIER_RIBBON", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "COOL_RIBBON", "COOL_RIBBON_SUPER", "COOL_RIBBON_HYPER",
        "COOL_RIBBON_MASTER", "BEAUTY_RIBBON", "BEAUTY_RIBBON_SUPER", "BEAUTY_RIBBON_HYPER", "BEAUTY_RIBBON_MASTER", "CUTE_RIBBON",
        "CUTE_RIBBON_SUPER", "CUTE_RIBBON_HYPER", "CUTE_RIBBON_MASTER", "SMART_RIBBON", "SMART_RIBBON_SUPER", "SMART_RIBBON_HYPER",
        "SMART_RIBBON_MASTER", "TOUGH_RIBBON", "TOUGH_RIBBON_SUPER", "TOUGH_RIBBON_HYPER", "TOUGH_RIBBON_MASTER", "CHAMPION_RIBBON", "WINNING_RIBBON",
        "VICTORY_RIBBON", "ARTIST_RIBBON", "EFFORT_RIBBON", "BATTLE_CHAMPION_RIBBON", "REGIONAL_CHAMPION_RIBBON", "NATIONAL_CHAMPION_RIBBON",
        "COUNTRY_RIBBON", "NATIONAL_RIBBON", "EARTH_RIBBON", "WORLD_RIBBON", "COOL_RIBBON", "COOL_RIBBON_GREAT", "COOL_RIBBON_ULTRA",
        "COOL_RIBBON_MASTER", "BEAUTY_RIBBON", "BEAUTY_RIBBON_GREAT", "BEAUTY_RIBBON_ULTRA", "BEAUTY_RIBBON_MASTER", "CUTE_RIBBON",
        "CUTE_RIBBON_GREAT", "CUTE_RIBBON_ULTRA", "CUTE_RIBBON_MASTER", "SMART_RIBBON", "SMART_RIBBON_GREAT", "SMART_RIBBON_ULTRA",
        "SMART_RIBBON_MASTER", "TOUGH_RIBBON", "TOUGH_RIBBON_GREAT", "TOUGH_RIBBON_ULTRA", "TOUGH_RIBBON_MASTER", "UNUSED", "UNUSED", "UNUSED",
        "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED"};
    constexpr std::string_view gen5ToggleTexts[]  = {"SINNOH_CHAMP_RIBBON", "ABILITY_RIBBON", "GREAT_ABILITY_RIBBON", "DOUBLE_ABILITY_RIBBON",
        "MULTI_ABILITY_RIBBON", "PAIR_ABILITY_RIBBON", "WORLD_ABILITY_RIBBON", "ALERT_RIBBON", "SHOCK_RIBBON", "DOWNCAST_RIBBON", "CARELESS_RIBBON",
        "RELAX_RIBBON", "SNOOZE_RIBBON", "SMILE_RIBBON", "GORGEOUS_RIBBON", "ROYAL_RIBBON", "GORGEOUS_ROYAL_RIBBON", "FOOTPRINT_RIBBON",
        "RECORD_RIBBON", "EVENT_RIBBON", "LEGEND_RIBBON", "WORLD_CHAMPION_RIBBON", "BIRTHDAY_RIBBON", "SPECIAL_RIBBON", "SOUVENIR_RIBBON",
        "WISHING_RIBBON", "CLASSIC_RIBBON", "PREMIER_RIBBON", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "COOL_RIBBON", "COOL_RIBBON_SUPER",
        "COOL_RIBBON_HYPER", "COOL_RIBBON_MASTER", "BEAUTY_RIBBON", "BEAUTY_RIBBON_SUPER", "BEAUTY_RIBBON_HYPER", "BEAUTY_RIBBON_MASTER",
        "CUTE_RIBBON", "CUTE_RIBBON_SUPER", "CUTE_RIBBON_HYPER", "CUTE_RIBBON_MASTER", "SMART_RIBBON", "SMART_RIBBON_SUPER", "SMART_RIBBON_HYPER",
        "SMART_RIBBON_MASTER", "TOUGH_RIBBON", "TOUGH_RIBBON_SUPER", "TOUGH_RIBBON_HYPER", "TOUGH_RIBBON_MASTER", "CHAMPION_RIBBON", "WINNING_RIBBON",
        "VICTORY_RIBBON", "ARTIST_RIBBON", "EFFORT_RIBBON", "BATTLE_CHAMPION_RIBBON", "REGIONAL_CHAMPION_RIBBON", "NATIONAL_CHAMPION_RIBBON",
        "COUNTRY_RIBBON", "NATIONAL_RIBBON", "EARTH_RIBBON", "WORLD_RIBBON", "COOL_RIBBON", "COOL_RIBBON_GREAT", "COOL_RIBBON_ULTRA",
        "COOL_RIBBON_MASTER", "BEAUTY_RIBBON", "BEAUTY_RIBBON_GREAT", "BEAUTY_RIBBON_ULTRA", "BEAUTY_RIBBON_MASTER", "CUTE_RIBBON",
        ...
        "SMART_RIBBON_MASTER", "TOUGH_RIBBON", "TOUGH_RIBBON_GREAT", "TOUGH_RIBBON_ULTRA", "TOUGH_RIBBON_MASTER", "UNUSED", "UNUSED", "UNUSED",
        "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED"};
    constexpr std::string_view gen67ToggleTexts[] = {"UNUSED", "UNUSED", "SPATK_LEVEL_1", "HP_LEVEL_1", "ATTACK_LEVEL_1", "SPDEF_LEVEL_1",
        ...
        "SOUVENIR_RIBBON", "WISHING_RIBBON", "BATTLE_CHAMPION_RIBBON", "REGIONAL_CHAMPION_RIBBON", "NATIONAL_CHAMPION_RIBBON",
        "WORLD_CHAMPION_RIBBON", "UNUSED", "UNUSED", "HOENN_CHAMPION_RIBBON", "CONTEST_STAR_RIBBON", "COOLNESS_MASTER_RIBBON", "BEAUTY_MASTER_RIBBON",
        "CUTENESS_MASTER_RIBBON", "CLEVERNESS_MASTER_RIBBON", "TOUGHNESS_MASTER_RIBBON", "ALOLA_CHAMPION_RIBBON", "BATTLE_ROYAL_RIBBON",
    ...
    for (u32 i = 0; i < pkm->getLength(); i++)
    {
        ...
        else if (pkm->generation() == pksm::Generation::THREE)
        {
            switch (i)
            {
                ...
                // Egg and ability bit
                case 0x4B:
                    buttons[i].push_back(std::make_unique<HexEditButton>(30, 90 + 0 * 16, 13, 13, [this, i]() { return this->toggleBit(i, 6); },
                        ui_sheet_emulated_toggle_green_idx, i18n::localize("EGG"), true, 6));
                    buttons[i].back()->setToggled((pkm->rawData()[i] >> 6) & 0x1);
        ...
        case pksm::Generation::LGPE:
            switch (i)
            {
                ...
                case 0x14:
                    ...
                    break;
                case 0x5A ... 0x61:
                    Gui::text(i18n::move(Configuration::getInstance().language(), pkm->move((i - 0x5A) / 2)), 160, 100, FONT_SIZE_12, COLOR_WHITE,
                        TextPosX::CENTER, TextPosY::TOP);
                    break;
                case 0xDF:
                    Gui::text(i18n::game(Configuration::getInstance().language(), pkm->version()), 160, 100, FONT_SIZE_12, COLOR_WHITE,
